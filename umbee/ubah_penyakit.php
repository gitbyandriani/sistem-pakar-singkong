...
$penyakit = query("SELECT * FROM tb_penyakit WHERE id_penyakit = $id")[0];
    ...
    <div class="card col-md-10 p-5 pt-3">
      ...
      <div class="card-body">
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-5">
              <input type="text" name="id_penyakit" class="form-control" id="id_penyakit" value="<?=$penyakit["id_penyakit"]; ?>">
            </div>
          </div>
          <div class="row mb-3">
            <label for="kd_penyakit" class="col-sm-2 col-form-label">Kode Penyakit</label>
            <div class="col-sm-5">
              <input type="text" name="kd_penyakit" class="form-control" id="kd_penyakit" value="<?=$penyakit["kd_penyakit"]; ?>">
            </div>
          </div>
          <div class="row mb-3">
            <label for="nm_penyakit" class="col-sm-2 col-form-label">Nama Penyakit</label>
            <div class="col-sm-5">
              <input type="text" name="nm_penyakit" class="form-control" id="nm_penyakit" value="<?=$penyakit["nm_penyakit"]; ?>">
            </div>
          </div>
          <div class="row mb-3">
            <label for="penjelasan" class="col-sm-2 col-form-label">Deskripsi</label>
            <div class="col-sm-5">
              <input type="text" name="penjelasan" class="form-control" id="penjelasan" value="<?=$penyakit["penjelasan"]; ?>">
            </div>
          </div>
          <div class="row mb-3">
            <label for="ifyes" class="col-sm-2 col-form-label">ifyes</label>
            <div class="col-sm-5">
              <input type="text" name="ifyes" class="form-control" id="ifyes" value="<?=$penyakit["ifyes"]; ?>">
            </div>
          </div>
          <div class="row mb-3">
            <label for="ifno" class="col-sm-2 col-form-label">ifno</label>
            <div class="col-sm-5">
              <input type="text" name="ifno" class="form-control" id="ifno" value="<?=$penyakit["ifno"]; ?>">
            </div>
          </div>
