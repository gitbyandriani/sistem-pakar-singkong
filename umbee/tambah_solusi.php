  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg bg-secondary navbar-dark fixed-top">
      <div class="container-fluid">
        <a class="navbar-brand" href="index_admin.php">Selamat Datang Admin di Halaman Admin </a>
        <a href="logout.php">
    ...
    <div class="card col-md-10 p-5 pt-3">
      <div class="card-header">
        <h3>Tambah Data Solusi</h3></div>
      <div class="card-body">
        <form action="" method="post">
        <div class="row mb-3">
            <label for="id_pengendalian" class="col-sm-2 col-form-label">Id Pengendalian</label>
            <div class="col-sm-5">
              <input type="text" name="id_pengendalian" class="form-control" id="id_pengendalian" required>
            </div>
          </div>
          <div class="row mb-3">
            <label for="kd_pengendalian" class="col-sm-2 col-form-label">Kode Pengendalian</label>
            <div class="col-sm-5">
              <input type="text" name="kd_pengendalian" class="form-control" id="kd_pengendalian" required>
            </div>
          </div>
          <div class="row mb-3">
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-5">
              <textarea type="text" name="pengendalian" class="form-control" rows="3" id="pengendalian" required></textarea>
            </div>
          </div>
